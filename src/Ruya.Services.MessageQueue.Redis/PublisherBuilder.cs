...
internal sealed class RedisPublisherBuilder<TMessage> : IMessagePublisherBuilder<TMessage> where TMessage : class
{
    private readonly RedisMessageQueue _bus;
    private readonly string _topic;
    private readonly PublishOptions _options;

    public RedisPublisherBuilder(RedisMessageQueue bus, string topic)
    {
        _bus = bus;
        _topic = topic;
