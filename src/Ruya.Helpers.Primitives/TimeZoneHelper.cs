...
namespace Ruya.Helpers.Primitives
{
    public class TimeZoneHelper
    {
        ...
        public static Dictionary<TimeZoneId, TimeZoneType> TimeZoneIds => new Dictionary<TimeZoneId, TimeZoneType>
                                                                          {
                                                                              {
                                                                                  TimeZoneId.EasternStandardTime, new TimeZoneType
                                                                                                                  {
                                                                                                                      Windows = "Eastern Standard Time",
                                                                                                                      NonWindows = "America/New_York"
                                                                                                                  }
                                                                              },
                                                                              {
                                                                                  TimeZoneId.CentralStandardTime, new TimeZoneType
                                                                                                                  {
                                                                                                                      Windows = "Central Standard Time",
                                                                                                                      NonWindows = "America/Chicago"
                                                                                                                  }
                                                                              },
                                                                              {
                                                                                  TimeZoneId.PacificStandardTime, new TimeZoneType
                                                                                                                  {
                                                                                                                      Windows = "Pacific Standard Time",
                                                                                                                      NonWindows = "America/Los_Angeles"
                                                                                                                  }
                                                                              }
                                                                          };
