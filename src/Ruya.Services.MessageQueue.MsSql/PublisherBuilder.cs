...
internal sealed class MsSqlPublisherBuilder<TMessage> : IMessagePublisherBuilder<TMessage> where TMessage : class
{
    private readonly MsSqlMessageQueue _bus;
    private readonly string _topic;
    private readonly PublishOptions _options;

    public MsSqlPublisherBuilder(MsSqlMessageQueue bus, string topic)
    {
        _bus = bus;
        _topic = topic;
