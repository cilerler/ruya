--! Ruya MessageQueue tests - Enable Service Broker in the isolated integration-test database.
--! Parameters:
...
IF NULLIF(@DatabaseName, N'') IS NULL
    THROW 51202, 'DatabaseName is required.', 1;
IF NOT EXISTS
(
    SELECT 1
    ...
    THROW 51210, 'The requested test database does not exist.', 1;
